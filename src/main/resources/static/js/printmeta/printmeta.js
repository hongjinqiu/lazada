var printmeta_Module_Factory = function () {
  var printmeta = {
    name: 'printmeta',
    defaultElementNamespaceURI: 'https:\/\/github.com\/onlyou\/printmeta',
    typeInfos: [{
...
if (typeof define === 'function' && define.amd) {
  define([], printmeta_Module_Factory);
}
else {
  var printmeta_Module = printmeta_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.printmeta = printmeta_Module.printmeta;
  }
  else {
    var printmeta = printmeta_Module.printmeta;
  }
}